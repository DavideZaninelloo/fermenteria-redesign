        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-xl font-serif mb-3 text-white">Sicurezza Totale</h4>
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-xl font-serif mb-3 text-white">Gusto Senza Filtri</h4>
              <p className="text-white/90 text-sm">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-xl font-serif mb-3 text-white">Tutti allo Stesso Tavolo</h4>
              <p className="text-white/90 text-sm">
